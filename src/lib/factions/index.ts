// Re-export all types
export type { UnitStats, HeroAbility, HeroSpec, HeroClassData, Unit, Faction, Loadout, GrandFaction, GrandFactionId, RetinueData } from "./types";
...
export const GRAND_FACTIONS: GrandFaction[] = [
  {
    ...
    banner: "/assets/alliance/banner.png",
  ...
  },
  {
    ...
    banner: "/assets/horde/banner.png",
    baseFactionId: "orcs",
  ...
  },
  {
    ...
    banner: "/assets/scourge/banner.png",
